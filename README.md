...
* **Zero Lag (Multithreading):** Separates the geometry logic from the rendering engine. The main graphics thread runs at an uninterrupted 120 FPS, while a lightweight background thread scans the screen for interactions.
